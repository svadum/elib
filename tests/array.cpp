...
TEST_CASE("array default construction", "[elib::array]") {
...
TEST_CASE("array push_back and size", "[elib::array]") {
    elib::array<int, 5> arr;
...
TEST_CASE("array pop_back", "[elib::array]") {
...
TEST_CASE("array insert", "[elib::array]") {
...
TEST_CASE("array erase", "[elib::array]") {
    elib::array<int, 4> arr;
...
TEST_CASE("array at() method", "[elib::array]") {
    elib::array<int, 3> arr;
...
TEST_CASE("array data() method", "[elib::array]") {
    elib::array<int, 3> arr;
...
TEST_CASE("array full() method", "[elib::array]") {
