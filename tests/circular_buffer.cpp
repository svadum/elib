...
TEST_CASE("Default construction", "[elib::circular_buffer]") {
...
TEST_CASE("Push and pop elements", "[elib::circular_buffer]") {
    elib::circular_buffer<int, 4> buf;
...
TEST_CASE("Push until full", "[elib::circular_buffer]") {
...
TEST_CASE("Push over old elements", "[elib::circular_buffer]") {
    elib::circular_buffer<int, 3> buf;
...
TEST_CASE("Iterator traversal works", "[elib::circular_buffer]") {
...
TEST_CASE("Iterator wrap-around works", "[elib::circular_buffer]") {
    elib::circular_buffer<int, 5> buf;
...
TEST_CASE("Initializer list construction", "[elib::circular_buffer]") {
...
TEST_CASE("Array construction", "[elib::circular_buffer]") {
    int arr[] = {10, 20, 30};
...
TEST_CASE("Move semantics", "[elib::circular_buffer]") {
    elib::circular_buffer<int, 5> buf;
    buf.push(1);
    buf.push(2);
...
TEST_CASE("std::next works", "[elib::circular_buffer]") {
    elib::circular_buffer<int, 5> buf;
    buf.push(100);
    buf.push(200);
    buf.push(300);
